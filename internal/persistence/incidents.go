...
// SaveIncidentState writes the incident snapshot to its dedicated
...
func (s *Manager) SaveIncidentState(
	ctx context.Context,
...
// incident persistence.
//
// The legacy SaveIncidents/GetIncidents pair remains isolated in
// incidents_legacy.go for compatibility fixtures and old-format recovery.
func (s *Manager) SavePersistedIncidents(
	ctx context.Context,
	incidents []model.PersistedIncident,
) error {
...
func (s *Manager) SavePersistedGroups(
	ctx context.Context,
	groups []model.PersistedGroup,
) error {
...
func (s *Manager) LoadPersistedGroups(
	ctx context.Context,
...
func (s *Manager) SaveProviderThreads(
	ctx context.Context,
	threads map[string]map[string]string,
) error {
...
func (s *Manager) LoadProviderThreads(
	ctx context.Context,
...
// SaveEngineState stores the incident engine's remaining working memory
// beside the incidents it belongs to.
func (s *Manager) SaveEngineState(
	ctx context.Context,
	engine model.PersistedEngineState,
) error {
...
func (s *Manager) LoadEngineState(
	ctx context.Context,
...
func (s *Manager) loadLegacyPayload(
	ctx context.Context,
	key string,
	out any,
) error {
