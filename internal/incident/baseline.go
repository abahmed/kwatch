...
//   - Workload incidents carry an owner-level baseline ("" seeded at startup);
//     drop it plus any Pods the incident accumulated.
//
// Caller must hold e.mu.
func (e *Engine) removeBaselineForIncident(
...
func cloneBaseline(
	src map[string]map[string]int64,
