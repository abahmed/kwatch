...
// DiscordRenderer produces Discord-formatted text from a Report.
...
func (dr *DiscordRenderer) RenderCreate(r *Report) string {
	var s []string

	s = append(s, dr.renderHeader(r))
	s = append(s, dr.renderDetails(r))
	...
	s = append(s, dr.renderEvidence(r))

	if r.Changes != nil && len(r.Changes.Items) > 0 {
		s = append(s, dr.renderChanges(r.Changes))
	}
...
func (dr *DiscordRenderer) RenderUpdate(r *Report) string {
	var s []string
...
func (dr *DiscordRenderer) RenderResolved(r *Report) string {
	var s []string
...
func (dr *DiscordRenderer) renderHeader(r *Report) string {
...
func (dr *DiscordRenderer) renderDetails(r *Report) string {
	var parts []string
	if r.Identity != nil {
...
func (dr *DiscordRenderer) renderTypeSpecific(r *Report) string {
	var parts []string
...
func (dr *DiscordRenderer) renderSuppressed(r *Report) string {
...
func (dr *DiscordRenderer) renderEvidence(r *Report) string {
	if r.Evidence == nil {
		return ""
	}
	var parts []string
...
func (dr *DiscordRenderer) renderChanges(c *ChangesSection) string {
	var parts []string
