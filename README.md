...
helm install [RELEASE_NAME] kwatch/kwatch --namespace kwatch --create-namespace --version 0.9.2
```
...
```shell
kubectl delete -f https://raw.githubusercontent.com/abahmed/kwatch/v0.9.2/deploy/config.yaml
kubectl delete -f https://raw.githubusercontent.com/abahmed/kwatch/v0.9.2/deploy/deploy.yaml
```
