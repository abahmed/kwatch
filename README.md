...
helm install [RELEASE_NAME] kwatch/kwatch --namespace kwatch --create-namespace --version 0.8.1
```
...
```shell
kubectl delete -f https://raw.githubusercontent.com/abahmed/kwatch/v0.8.1/deploy/config.yaml
kubectl delete -f https://raw.githubusercontent.com/abahmed/kwatch/v0.8.1/deploy/deploy.yaml
```
