...
// KwatchUpdateMsg is used to notify all registered providers when a newer version is available
const KwatchUpdateMsg = ":tada: A newer version <https://github.com/abahmed/kwatch/releases/tag/%[1]s|%[1]s> of Kwatch is available! Please update to the latest version."
